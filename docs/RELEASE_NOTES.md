...
- **LinkedIn drafts:** Lab Intelligence Ledger, https://claude.ai/artifact/Ai5xKScgT2sWtqXRQ1ZA8i — posts 49–53, tagged Bookable, one per pillar (AI, Scale, Impact, MarTech, AI), queued after Groundwork: the two-1:30s time trap, the room that is never full (A-082), the colour drawn 90 minutes late (A-093), the half-visible no-show warning (A-120), and the running-late claim that follows the next client (A-135).
